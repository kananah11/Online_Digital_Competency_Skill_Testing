...
<div class="container">
    <div class="row">
        <div class="col-md-12"> <br />
            <h3 align="center">อนุมัติข้อสอบ</h3> <br />
   ...
   <div class='row'id="image_preview" >
     @foreach($images as $rows)
            ...
            <form method="post" action="{{action('ApproveController@update',$id)}}">
                {{csrf_field()}}
        ...
        <div class="form-group">
                ...
                <div class="form-group" hidden>
                    <input type="radio" id="medium" name="status" checked="ture" value="อนุมัติ">&nbsp;อนุมัติ &nbsp; &nbsp;
                </div>


                <div class="form-group">
                    <input type="submit" class="btn btn-primary" value="บันทึกและอนุมัติ" />
                    <a type="button" href="{{action('ApproveController@show', $id)}}" class="btn btn-danger" >ยกเลิก</a>
                </div>
